...
<div id="background-container"></div>
    ...
    <div id="sidebar-content">
        <ul style="margin-top: 50px;">
            <li><a href="employee_dashboard.php" class="sidebar-link">Home</a></li>
            <li style="margin-top: 20px;"> <a href="book_list.php" class="sidebar-link">View Files</a></li>
            <li style="margin-top: 20px;"> <a href="add_book.php" class="sidebar-link">Add Files</a></li>
